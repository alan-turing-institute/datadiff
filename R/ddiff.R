...
ddiff <- function(df1, df2,
  ...
  # identity patch and break patch as possible candidates. When i != j the
  # penalty includes that associated with a permutation of columns.
  #
  ...
  #
  # - Construct (and return) the patch determined by the solution to the
  # assignment problem, comprising zero or more columnwise patches, perhaps
  # followed by a permutation patch.
